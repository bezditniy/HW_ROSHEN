...
import LeatherFieldNotesCards from "../../components/ProductCards/LeatherFieldNotesCards";

import FieldNoteBanner from "../../Img/Banners/FieldNoteBanner.png"

function LeatherFieldNotesCatalog () {
            ...
            <Container fluid style={{padding: "0px"}}>
                <div className="banner-style">
                    <div className="img-container">
                       <img className="img-banner" src={FieldNoteBanner}/> 
                    </div>
                    <div className="overlay-container">
                        <div className="txt-container">
                            <h1 className="txt-overlay">Field Notes Covers</h1>
                        </div>
                    </div>
                </div> 
            </Container>
...
export default LeatherFieldNotesCatalog