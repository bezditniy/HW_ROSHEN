...
import Accessories from "../../components/ProductCards/Accessories";


import AccessoriesBanner from "../../Img/Banners/AccessoriesBanner.png"
            ...
            <Container fluid style={{padding: "0px"}}>
                <div className="banner-style">
                    <div className="img-container">
                       <img className="img-banner" src={AccessoriesBanner}/> 
                    </div>
                    <div className="overlay-container">
                        <div className="txt-container">
                            <h1 className="txt-overlay">Accessories</h1>
                        </div>
                    </div>
                </div> 
            </Container>
