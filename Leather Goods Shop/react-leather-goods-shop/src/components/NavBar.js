    ...
    return (
        <Navbar expand="xl" variant="dark">
            <Container className="">
                ...
                <Navbar.Toggle style={{background: "none", width: "100px"}} aria-controls="responsive-navbar-nav"/>
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="mx-auto">
                        ...
                        <Nav.Link href="/page" className="hover-txt ps-xl-4">LookBook</Nav.Link>
                        <Nav.Link className="hover-txt ps-xl-4">Contact Us</Nav.Link>
                    </Nav>
