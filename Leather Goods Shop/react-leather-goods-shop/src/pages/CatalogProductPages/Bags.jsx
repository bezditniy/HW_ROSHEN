...
import BagsCards from "../../components/ProductCards/BagsCards";

import LeatherBagBanner from "../../Img/Banners/LeatherBagBanner.png"
            ...
            <Container fluid style={{padding: "0px"}}>
                <div className="banner-style">
                    <div className="img-container">
                       <img className="img-banner" src={LeatherBagBanner}/> 
                    </div>
                    <div className="overlay-container">
                        <div className="txt-container">
                            <h1 className="txt-overlay">Bags</h1>
                        </div>
                    </div>
                </div> 
            </Container>
