...
import BraceletsCards from "../../components/ProductCards/BraceletsCards";

import BraceletBanner from "../../Img/Banners/BraceletBanner.png"

function BraceletsCatalog () {
            ...
            <Container fluid style={{padding: "0px"}}>
                <div className="banner-style">
                    <div className="img-container">
                       <img className="img-banner" src={BraceletBanner}/> 
                    </div>
                    <div className="overlay-container">
                        <div className="txt-container">
                            <h1 className="txt-overlay">Bracelets</h1>
                        </div>
                    </div>
                </div> 
            </Container>
...
export default BraceletsCatalog