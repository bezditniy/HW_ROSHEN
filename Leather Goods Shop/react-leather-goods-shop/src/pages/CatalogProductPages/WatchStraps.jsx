...
import WatchStrapsCards from "../../components/ProductCards/WatchStrapsCards";

import WatchStrapsBanner from "../../Img/Banners/WatchStrapsBanner.png"

function WatchStrapsCatalog () {
            ...
            <Container fluid style={{padding: "0px"}}>
                <div className="banner-style">
                    <div className="img-container">
                       <img className="img-banner" src={WatchStrapsBanner}/> 
                    </div>
                    <div className="overlay-container">
                        <div className="txt-container">
                            <h1 className="txt-overlay">Watch Straps</h1>
                        </div>
                    </div>
                </div> 
            </Container>
...
export default WatchStrapsCatalog