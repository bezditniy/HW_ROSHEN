...
import BeltsCards from "../../components/ProductCards/BeltsCards";

import LeatherBeltBanner from "../../Img/Banners/LeatherBeltBanner.png"

function BeltsCatalog () {
            ...
            <Container fluid style={{padding: "0px"}}>
                <div className="banner-style">
                    <div className="img-container">
                       <img className="img-banner" src={LeatherBeltBanner}/> 
                    </div>
                    <div className="overlay-container">
                        <div className="txt-container">
                            <h1 className="txt-overlay">Belts</h1>
                        </div>
                    </div>
                </div> 
            </Container>
