...
import PhoneCasesCards from "../../components/ProductCards/PhoneCasesCards";

import PhoneBanner from "../../Img/Banners/PhoneBanner.png"

function PhoneCasesCatalog () {
            ...
            <Container fluid style={{padding: "0px"}}>
                <div className="banner-style">
                    <div className="img-container">
                       <img className="img-banner" src={PhoneBanner}/> 
                    </div>
                    <div className="overlay-container">
                        <div className="txt-container">
                            <h1 className="txt-overlay">Phone Cases</h1>
                        </div>
                    </div>
                </div> 
            </Container>
...
export default PhoneCasesCatalog